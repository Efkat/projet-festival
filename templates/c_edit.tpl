                ...
                <form action="./c_edit" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" class="form-control" id="codepostal-input" placeholder="Entrez votre code postal" value="{$candidature['codepostal']}" name="codepostal" required>
                        </div>
                        <div class="my-3">
                            <label for="phone-input">Numéro de téléphone : </label>
                            <input type="text" class="form-control" id="phone-input" placeholder="Entrez votre téléphone" value="{$candidature['phone']}" name="phone" required>
                        </div>
                        <div class="my-3">
